...
// Hash File Generator
//        hashTableGenerator("ref_result_1");
//        hashFileWriter("testResult_1");
...
// Hash Test Testbench
        ...
        strcpy(hash_file_name, "testResult_1");
        strcpy(ref_file_name,  "ref_result_1");
        strcpy(out_file_name,  "verify_output_1");
