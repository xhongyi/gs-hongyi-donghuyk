...
ED_partial_result editDistanceCalFWD(char* test_read, char* ref_read, int key_num);

ED_partial_result editDistanceCalBWD(char* test_read, char* ref_read, int key_num);
